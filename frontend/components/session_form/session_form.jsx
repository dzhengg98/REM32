...
// Tried to change to a functional component but created a infinite loop
...
//   const length = props.errors.length

//   useEffect(() => {
//     debugger
//     if (length) {
//       props.clearErrors();
//     }}, [length, props.clearErrors()]
//   )
...
//           type="submit"
//           className = "button"
//           value={props.formType === "login" ? "Log in" : "Sign up"}
//         />
        
//         {props.formType === "login" ? renderDemoLogin() : " "}
//         {renderLink()}
//       </form>
//     </div>
//   )
