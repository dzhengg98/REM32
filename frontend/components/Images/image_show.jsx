...
const ImageShow = (props) => {
  ...
  const likeable = () => {
    ...
    return (
      <div onClick={ currentUserLike ? removeLike : addLike } className="svg-like-icon">
  ...
  const userProfilePic = () => {
    return users[image.uploaderId]['profilepic'] ? (
      <Link to={`/users/${image.uploaderId}`}>
        <img className="circular" src={users[image.uploaderId]['profilepic']} alt="circular icon" draggable="false"/>
      </Link>      
    ) : (
      <Link to={`/users/${image.uploaderId}`}>
        <img src={window.userIcon} draggable="false" alt="user icon"/>
      </Link>      
    )
  }
    ...
    <div>
      <div className="image-show-container">
        ...
        <div className="image-container">
          ...
          <img className="show-image" src={image.imageUrl} alt="show image" draggable="false"/>
        </div>
          ...
          <div className="inner-info-comment-container">
            <div className="image-info-container">
              <div className="icons">
                ...
                <div className="svg-icon">
                  <div className="image-show-share-icon">
